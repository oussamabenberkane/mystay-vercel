...
export function PushPermissionPrompt() {
  ...
  const showNormal = isSupported && !isSubscribed && !isDismissed && !isPermissionDenied
  const showIOS = isIOS && !isStandalone && !isDismissed

  useEffect(() => {
    if (showNormal || showIOS) {
      const t = setTimeout(() => setVisible(true), 800)
      return () => clearTimeout(t)
    }
  }, [showNormal, showIOS])

  if (!showNormal && !showIOS) return null
          ...
          <div className="pp-card">
            ...
            <div className="pp-icon-wrap">
              ...
              <div className="pp-icon-bg">
                {showIOS
                  ? <Share size={17} className="pp-bell" />
            ...
            <div className="pp-body">
              ...
              {showIOS ? (
                <>
                  <h2 className="pp-title">Add to Home Screen</h2>
                  <ul className="pp-ios-steps">
                    <li>
                      <span className="pp-ios-step-num">1</span>
                      Tap the Share button in Safari
                    </li>
                    <li>
                      <span className="pp-ios-step-num">2</span>
                      Select &ldquo;Add to Home Screen&rdquo;
                    </li>
                    <li>
                      <span className="pp-ios-step-num">3</span>
                      Open the app and enable alerts
                    </li>
                  </ul>
                </>
              ) : (
                <>
                  ...
                  {subscribeError && (
                    <p className="pp-error">{subscribeError}</p>
                  )}
                </>
              )}
