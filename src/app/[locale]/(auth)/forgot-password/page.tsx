      ...
      >
        ...
        <div className="relative px-8 pt-9 pb-8 flex flex-col items-center overflow-hidden" style={{ background: '#1B2D5B' }}>
          ...
          <div className="auth-up-3 flex items-center gap-2 mt-1.5">
            ...
            <p className="text-[9px] font-bold uppercase tracking-[0.3em] text-[#C9A84C]">Password Recovery</p>
            <div className="h-px w-4" style={{ background: 'rgba(201,168,76,0.45)' }} />
          </div>
        </div>
        ...
        <div className="bg-white px-8 pb-8">
          ...
          {success ? (
            <div className="auth-up-3 flex flex-col items-center text-center py-2">
              ...
              <p className="font-heading text-lg font-bold text-[#1B2D5B] mb-2">Check your inbox</p>
              <p className="text-sm text-[#7A8BA8] leading-relaxed mb-6">
                A password reset link has been sent to your email. Follow the instructions to regain access.
              </p>
            ...
            <>
              <p className="auth-up-3 text-[10px] font-bold uppercase tracking-[0.25em] text-[#C9A84C] text-center mb-5">
                Reset Password
              </p>
              <p className="auth-up-3 text-sm text-[#7A8BA8] text-center mb-6 leading-relaxed">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                <div className="auth-up-4">
                  ...
                  <input
                    {...register('email')}
                    type="email" autoComplete="email" placeholder="guest@example.com"
